...
var opcodes65c24T8Delta = [256]opcode{
	...
	0x7B: {"LDA", 1, 7, false, modeXY, buildOpLoad(regA)},
	0x8B: {"STA", 1, 7, false, modeXY, buildOpStore(regA)},
	0x9B: {"LDA", 1, 9, false, modeIndirectXY, buildOpLoad(regA)},
	0xAB: {"STA", 1, 9, false, modeIndirectXY, buildOpStore(regA)},
	0xBB: {"LDA", 1, 9, false, modeIndexedIndirectXY, buildOpLoad(regA)},
	0xCB: {"STA", 1, 9, false, modeIndexedIndirectXY, buildOpStore(regA)},
